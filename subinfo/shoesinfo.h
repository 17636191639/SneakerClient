...
public:
    ShoesInfo();
    ShoesInfo(const QString &m_id, const QString &m_storeID, const QString &m_photoID,
              const QString &m_shoesName, const QString &m_bottomPrice, const QString &m_freight);
